export default {
  ...
  aboutP3: 'И еще кое-что:',
  aboutP3_1: 'Первый звонок во время старта сессии не считается, но он поможет тебе отрегулировать громкость.',
  aboutP3_2: 'Последний звонок отличается звуком, так что не волнуйся, ты не пропустишь окончание сессии (если не уснёшь, конечно).',
  aboutP3_3: 'Сигналы расставлены во времени случайным образом (кроме последнего), так что будет интересно.',
