export default {
  ...
  aboutP3: 'And there is something else:',
  aboutP3_1: 'The bell at the beginning of a session doesn\'t count but it helps you to adjust a sound volume.',
  aboutP3_2: 'The last bell differs from others so no worry, you don\'t miss the end of session (unless you sleep, of course).',
  aboutP3_3: 'The bells are randomly placed in time (except of the last) so it\'s gonna be interesting.',
